//
//  CTDateConvertTool.m
//  CloutropySDK Example
//
//  Created by xiaochen yang on 2018/11/19.
//  Copyright © 2018 chainedbox. All rights reserved.
//

#import "CTDateConvertTool.h"

@implementation CTDateConvertTool
...
+ (NSString *)getYearWithTimeStamp:(NSInteger)timeStamp {
    NSDate *date = [NSDate dateWithTimeIntervalSince1970:timeStamp];
    NSCalendar* calendar = [NSCalendar currentCalendar];
    NSDateComponents* components = [calendar components:NSCalendarUnitYear fromDate:date]; // Get necessary date components
    return [NSString stringWithFormat:@"%zu", [components year]];
}
...
+ (NSInteger)getLastNight12TimeStamp {
...
//    NSDateFormatter *dateFomater = [[NSDateFormatter alloc] init];
//    dateFomater.dateFormat = @"yyyy";
//    return [dateFomater stringFromDate:originalDate];
//}
